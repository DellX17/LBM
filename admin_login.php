...
//variable que uso para manejar los diferentes casos en el login
$message = '';

//login en el mismo php
if(isset($_POST["login_button"]))
{
	...
	{
		$message .= '<li>El correo es obligatorio</li>';
	}
	else
	{
	...
	{
		$message .= '<li>La contraseña es requerida</li>';
	}
	else
	{
	...
	if($message == '')
	{
		...
		if($statement->rowCount() > 0)
		{
			foreach($statement->fetchAll() as $row)
			{
				...
				{
					//Autenticado, se aloja una sesión y se envía a el bloque de admin
				...
				{
					$message = '<li>Contraseña incorrecta</li>';
				}
			}
		}	
		else
		{
			$message = '<li>No existe tal usuario</li>';
		}
	}
