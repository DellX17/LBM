...
if(isset($_POST['save_button']))
{
	...
	{
		$message .= '<li>Contraseña requerida</li>';
	}
	else
	{
	...
	{
		$message .= '<li>Usuario requerido</li>';
	}
	else
	{
	...
	{
		$message .= '<li>Número requerido</li>';
	}
	else
	{
	...
	{
		$message .= '<li>Dirección requerida</li>';
	}
	else
	{
	...
	if(!empty($_FILES['user_profile']['name']))
	{
		...
		if(in_array($img_ext, $extensions))
		{
			if($image_size <= 2000000)
			{
				...
				{
					$message .= '<li>Dimensiones incorrectas</li>';
				}
			}
			else
			{
				$message .= '<li>Exedidos 2MB</li>';
			}
		}
		else
		{
			$message .= '<li>Formato invalido</li>';
		}
	}
			...
			?>
				<form method="POST" enctype="multipart/form-data">
					...
					<div class="mb-3">
						...
						<br />
						<span class="text-muted">Solo permite jpg y png.</span>
						<br />
					...
					<div class="text-center mt-4 mb-2">
						<input type="submit" name="save_button" class="btn btn-primary" value="Guardar cambios" />
					</div>
				</form>
