...
if(isset($_POST["add_book"]))
{
	...
	{
		$error .= '<li>El nombre es obligatorio</li>';
	}
	else
	{
	...
	{
		$error .= '<li>La categoría es obligatoria</li>';
	}
	else
	{
	...
	{
		$error .= '<li>El autor es requerido</li>';
	}
	else
	{
	...
	{
		$error .= '<li>El anaquel del libro es requerido</li>';
	}
	else
	{
	...
	{
		$error .= '<li>El ISBN es requerido</li>';
	}
	else
	{
	...
	{
		$error .= '<li>El No. De copias es requerido</li>';
	}
	else
	{
...
if(isset($_POST["edit_book"]))
{
	...
	if(empty($_POST["book_category"]))
	{
		$error .= '<li>La categoria es obligatoria</li>';
	}
	else
	{
		$formdata['book_category'] = trim($_POST["book_category"]);
	...
	if(empty($_POST["book_no_of_copy"]))
	{
		$error .= '<li>El No. De copias del libro es requerido</li>';
	}
	else
	{
		$formdata['book_no_of_copy'] = trim($_POST["book_no_of_copy"]);
...
<div class="container-fluid py-4" style="min-height: 700px;">
	...
	<ol class="breadcrumb mt-4 mb-4 bg-light p-2 border">
        ...
        <li class="breadcrumb-item"><a href="book.php">Administrador de libros</a></li>
    ...
    <div class="card mb-4">
    	<div class="card-header">
    		<i class="fas fa-user-plus"></i> Nuevo libro
        </div>
        <div class="card-body">
        	<form method="post">
        		<div class="row">
        		...
        		<div class="mt-4 mb-3 text-center">
        			<input type="submit" name="add_book" class="btn btn-success" value="Nuevo" />
        		</div>
        	</form>
        </div>
    </div>
    ...
    <div class="card mb-4">
    	<div class="card-header">
    		<i class="fas fa-user-plus"></i> Editar detalles
       	</div>
       	<div class="card-body">
       		<form method="post">
       			<div class="row">
       			...
       			<div class="mt-4 mb-3 text-center">
       				...
       				<input type="submit" name="edit_book" class="btn btn-primary" value="Editar" />
       			</div>
       		</form>
       		<script>
	...
	<ol class="breadcrumb mt-4 mb-4 bg-light p-2 border">
		<li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
		<li class="breadcrumb-item active">Administrador de libros</li>
	</ol>
	<?php 
	...
	if(isset($_GET["msg"]))
	{
		if($_GET["msg"] == 'add')
		{
			echo '<div class="alert alert-success alert-dismissible fade show" role="alert">Nuevo libro agregado <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
		}
		if($_GET['msg'] == 'edit')
		{
		...
		if($_GET["msg"] == 'disable')
		{
			echo '<div class="alert alert-success alert-dismissible fade show" role="alert">Libro deshabilitado <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
		}
		if($_GET['msg'] == 'enable')
		{
			echo '<div class="alert alert-success alert-dismissible fade show" role="alert">Libro habilitado <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
		}
	}
		...
		<div class="card-header">
			<div class="row">
				<div class="col col-md-6">
					<i class="fas fa-table me-1"></i> Administrador de libros
                </div>
                <div class="col col-md-6" align="right">
                	<a href="book.php?action=add" class="btn btn-success btn-sm">Nuevo</a>
                </div>
            </div>
        </div>
        <div class="card-body">
        	<table id="datatablesSimple">
        		...
        		if($statement->rowCount() > 0)
        		{
        			foreach($statement->fetchAll() as $row)
        			{
        				...
        				{
        					$book_status = '<div class="badge bg-success">Habilitado</div>';
        				}
        				else
        				{
        					$book_status = '<div class="badge bg-danger">Deshabilitado</div>';
        				}
        				echo '
        				<tr>
        					<td>'.$row["book_name"].'</td>
        					...
        					<td>
        						<a href="book.php?action=edit&code='.convert_data($row["book_id"]).'" class="btn btn-sm btn-primary">Editar</a>
        						<button type="button" name="delete_button" class="btn btn-danger btn-sm" onclick="delete_data(`'.$row["book_id"].'`, `'.$row["book_status"].'`)">Habilitado</button>
        					</td>
        				</tr>
        				';
        			}
        		...
        		else
        		{
        			echo '
        			<tr>
        				<td colspan="10" class="text-center">Data en blanco</td>
        			</tr>
        			';
        		}
