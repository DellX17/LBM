...
//Edición y validación como en el login, mucho código similar
...
if(isset($_POST['edit_admin']))
{
	...
	{
		$error .= '<li>El correo es obligatorio</li>';
	}
	else
	{
		if(!filter_var($_POST["admin_email"], FILTER_VALIDATE_EMAIL))
		{
			$error .= '<li>Correo invalido</li>';
		}
		else
		{
	...
	{
		$error .= '<li>La contraseña es requerida</li>';
	}
	else
	{
			...
			<div class="card mb-4">
				...
				?>
					...
					<form method="post">
						...
						<div class="mt-4 mb-0">
							<input type="submit" name="edit_admin" class="btn btn-primary" value="Editar" />
						</div>
					</form>
