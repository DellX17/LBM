<?php
//Ajustes en general, me gustaria hacer más con esto pero ya no me ajusta el tiempo
...
//Edición y validación como en otros apartados
...
if(isset($_POST['edit_setting']))
{
	...
	$message = '
	<div class="alert alert-success alert-dismissible fade show" role="alert">Info actualizada <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>
	';
}
...
<div class="container-fluid px-4">
	...
	<div class="card mb-4">
		<div class="card-header">
			<i class="fas fa-user-edit"></i> Ajustes de la biblioteca
		</div>
		<div class="card-body">
			...
			<form method="post">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="mb-3">
							<label class="form-label">Días de prestamo maximos</label>
					...
					<div class="col-md-6">
						<div class="mb-3">
							<label class="form-label">Multa diaria</label>
				...
				<div class="row">
					<div class="col-md-6">
						<label class="form-label">Limíte de prestamos por usuario</label>
				...
				<div class="mt-4 mb-0">
					<input type="submit" name="edit_setting" class="btn btn-primary" value="Guardar" />
				</div>
