...
<div class="container-fluid py-4" style="min-height: 700px;">
    ...
    <div class="container-fluid py-4">
        <div class="row padding-up 10px">
    		<div class="col col-md-4">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" name="RBDate1" id="RBDate1"
                    onclick="if (this.checked){ 
                    document.getElementById('DCinitialCreation').removeAttribute('disabled');
                    document.getElementById('DCfinalCreation').removeAttribute('disabled')
                    this.value =true;
                    ;
                    }else{
                    document.getElementById('DCinitialCreation').setAttribute('disabled','');
                    document.getElementById('DCfinalCreation').setAttribute('disabled','');
                    this.value = false;
                    };">Fecha de prestamo
                </div>
            </div>
            ...
            <div class="col col-md-4">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" name="RBDate2" id="RBDate2"
                    onclick="if (this.checked){ 
                    document.getElementById('DCinitialReturn').removeAttribute('disabled');
                    document.getElementById('DCfinalReturn').removeAttribute('disabled');
                    }else{
                    document.getElementById('DCinitialReturn').setAttribute('disabled','');
                    document.getElementById('DCfinalReturn').setAttribute('disabled','');
                    };"
                    >Fecha de entrega
                </div>
            </div>
            ...
            <div class="col col-md-4">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" name="RDState" id="RDState"
                    onclick="if (this.checked){ 
                    document.getElementById('seleccionador').removeAttribute('disabled');
                    }else{
                    document.getElementById('seleccionador').setAttribute('disabled','');
                    };">Estado
                </div>
            </div>
        </div>
        ...
        <div class="row py-2">
            <div class="col col-md-4 ">
                <input type="date" name="DCinitialCreation" id="DCinitialCreation" disabled> Inicial
            </div>

            <div class="col col-md-4 ">
                <input type="date" name="DCinitialReturn" id="DCinitialReturn"disabled> Inicial
            </div>

            <div class="col col-md-4 ">
                <select name="seleccionador" id="seleccionador" name="seleccionador"disabled>
                    <option value="Return">Entregados</option>
                    <option value="Issue">Prestamo</option>
                    <option value="Not Return">Vencidos</option>
                </select>
            </div>
        </div>  
        ...
        <div class="row py-2">
            <div class="col col-md-4 ">
            <input type="date" name="DCfinalCreation" id="DCfinalCreation"disabled> Final
            </div>

            <div class="col col-md-4 ">
            <input type="date" name="DCfinalReturn" id="DCfinalReturn"disabled> Final
            </div>

            <div class="col col-md-4 ">
                <button onclick="peticionGet()" class="btn btn-outline-dark ">Busqueda avanzada</button>
            </div>
        </div>  
    </div>
    
        <div class="card-body" id="simpleDataTable">
...
<script>
        function peticionGet() {
            ...
            if (document.getElementById('DCinitialCreation').getAttribute('disabled')!=null) {
                var cDate1 = "";
            }else{
                var cDate1 = document.getElementById('DCinitialCreation').value;
                if (cDate1=="") {
                    cDate1="1900-01-01";
                }
                phpQ="AND `issue_date_time` BETWEEN '"+cDate1+"' ";
            }

            if (document.getElementById('DCfinalCreation').getAttribute('disabled')!=null) {
                var cDate2 = "";
            }else{
                var cDate2 = document.getElementById('DCfinalCreation').value;
                if (cDate2=="") {
                    cDate2="2100-01-01";
                }
                phpQ=phpQ+"AND '"+cDate2+"' ";
            }


            if (document.getElementById('DCinitialReturn').getAttribute('disabled')!=null) {
                var rDate1 = "";
            }else{
                var rDate1 = document.getElementById('DCinitialReturn').value;
                if (rDate1=="") {
                    rDate1="1900-01-01";
                }
                phpQ=phpQ+"AND `return_date_time` BETWEEN '"+rDate1+"' ";
            }

            if (document.getElementById('DCfinalReturn').getAttribute('disabled')!=null) {
                var rDate2 = "";
            }else{
                var rDate2 = document.getElementById('DCfinalReturn').value;
                if (rDate2=="") {
                    rDate2="2100-01-01";
                }
                phpQ=phpQ+"AND '"+rDate2+"' ";
            }

            if (document.getElementById('seleccionador').getAttribute('disabled')!=null) {
                var selector = "";
            }else{
                var selector = document.getElementById('seleccionador').value;
                phpQ=phpQ+"AND `book_issue_status` = '"+selector+"' "
            }

            
            var url = "dataTableAjax.php?param1=" + phpQ;
            ...
            xmlhttp.onreadystatechange = function () {
                ...
                if (xmlhttp.readyState == 4) {//estado Listo!
                    if (xmlhttp.status == 200) {//Recarga exitosa
                        document.getElementById('simpleDataTable').innerHTML = xmlhttp.responseText;
                    } else {
